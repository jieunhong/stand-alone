...
export function CelebrationDialog({ open, onClose, achievement }: CelebrationDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onClose}>
            <DialogContent className="max-w-sm bg-gradient-to-br from-white to-[#F0FFF0] border-2 border-[#7DD87D]/30 rounded-3xl">
                <DialogHeader>
                ...
                <div className="flex flex-col items-center py-6">
                    ...
                    <button
                        onClick={onClose}
                        className="mt-6 bg-gradient-to-r from-[#A8E6A3] to-[#7DD87D] text-white font-semibold py-3 px-8 rounded-2xl shadow-lg hover:shadow-xl transition-all"
                    >
                        확인
                    </button>
                </div>
